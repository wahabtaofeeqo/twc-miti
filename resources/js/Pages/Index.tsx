        ...
        <div className="max-w-7xl mx-auto h-full py-5 overlay">
            ...
            <div className="flex items-center p-3 h-full">
                <div className="lg:basis-2/4 mx-auto">
                    ...
                    <div>
                        <Link href="/tickets" className="py-3 px-10 bg-pink-700 text-white rounded shadow-sm me-3">Get Your Ticket</Link>
                ...
                <div className="hidden lg:flex basis-2/4 items-center justify-center">
                    <div className="rounded-full bg-white flex items-center justify-center main" style={{width: "500px", height: "500px"}}></div>
                </div>
            </div>
        </div>
    </div>
